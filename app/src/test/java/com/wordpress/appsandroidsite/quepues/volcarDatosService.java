...
import com.wordpress.appsandroidsite.quepues.soap.CategoriasParser;
import com.wordpress.appsandroidsite.quepues.soap.PreguntasParser;
import com.wordpress.appsandroidsite.quepues.soap.TestParser;
import com.wordpress.appsandroidsite.quepues.soap.UrlParser;
...
public class volcarDatosService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        thread.start();
        Intent i = new Intent(volcarDatosService.this, InicioActivity.class);
        startActivity(i);
